(function () {
    ...
    const colorScale = d3
      ...
      .range([
        "#1d476d", // Total Energy Consumption
    ...
    if (typeof csvFile === "undefined") {
      var csvFile = "../../data/energy/energy-system/energy-system1.csv";
    }
        ...
        Math.ceil(
          d3.max(data, (d) =>
            Math.max(
              ...
              d["Energy Consumption Per Capita"]
            )
          ) / 100
        ) * 100;
          ...
          tooltip.html(`
            ...
            <table class="tooltip-content">
              <tr>
                ...
                <td class="value">${hoverData["Total Energy Consumption"]}</td>
              </tr>
              <tr>
                ...
                <td class="value">${hoverData["Renewable Energy Consumption"]}</td>
              </tr>
              <tr>
                ...
                <td class="value">${hoverData["Energy Consumption Per Capita"]}</td>
              </tr>
            </table>
          `);
