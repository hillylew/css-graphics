(function () {
   /* ----------------------- Create Tooltip ------------------------ */
   const container = document.getElementById("biofuels-stacked-area-chart2");
   ...
   const tooltip = d3.select(container).select("#tooltip");
    ...
    // Append SVG object
    const svg = d3
      .select("#biofuels-stacked-area-chart2")
      .append("svg")
    ...
    d3.csv("../../data/energy/biofuels/biofuels2.csv").then((data) => {
