(function () {
  ...
  // Append SVG object
  const svg = d3
    .select("#greenhouse-gases-line-chart")
    .append("svg")
  ...
  const colorScale = d3
    ...
    .range([
      "#1d476d", // Transportation
      "#3167a4", // Electric Power Industry
      "#8fc8e5", // Industry
      "#386660", // Agriculture
      "#ce5845", // Commercial
      "#ed974a"  // Residential
  ...
  d3.csv("./data/greenhouse-gases/greenhouse-gases3.csv").then((data) => {
      ...
      if (hoverData) {
        tooltip.html(`
            ...
            <table class="tooltip-content">
              <tr>
                <td><span class="color-legend" style="background-color: ${colorScale("Transportation")};"></span>Transportation</td>
                <td class="value">${formatNumber(hoverData["Transportation"])}</td>
              </tr>
              <tr>
                <td><span class="color-legend" style="background-color: ${colorScale("Electric Power Industry")};"></span>Electric Power Industry</td>
                <td class="value">${formatNumber(hoverData["Electric Power Industry"])}</td>
              </tr>
              <tr>
                <td><span class="color-legend" style="background-color: ${colorScale("Industry")};"></span>Industry</td>
                <td class="value">${formatNumber(hoverData["Industry"])}</td>
              </tr>
              <tr>
                <td><span class="color-legend" style="background-color: ${colorScale("Agriculture")};"></span>Agriculture</td>
                <td class="value">${formatNumber(hoverData["Agriculture"])}</td>
              </tr>
              <tr>
